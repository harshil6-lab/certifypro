        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in relative z-10">
          ...
          <div className="space-y-4 pt-2">
            ...
            <Button
              ...
              variant="outline"
              type="button"
              className="w-full h-12 gap-3 font-medium text-foreground border-2 border-border hover:bg-accent/5 hover:border-accent/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
                <>
